...
void keyboard(unsigned char key,int x,int y)
{
	switch(key)
	{
		...
		case 'D':	roty++;
						break;
		case 'q':
		case 'Q':	if(frustum == 1)  // VISIBLE CLEARLY IN PERSPECTIVE VIEW
						viewer[2] += 0.5;
						break;
		case 'e':
		case 'E':	if(frustum == 1)
...
void first()
{
	...
	glColor3f(1,0,0);
	strokeString(320,720,0.4,0.3,"ICG PROJECT",3);
	glColor3f(1,1,1);
	strokeString(150,600,0.4,0.3,"SIMULATION OF MOTION OF",3);
	strokeString(125,550,0.37,0.3,"ELECTRONS AROUND AN ATOM",3);
	glColor3f(0,0.5,0.6);
	
	strokeString(110,320,0.25,0.2,"NUMBER OF ELECTRONS:",3);
	glColor3f(1,0,1);
	char str[5];
	sprintf(str, "%d", n);
	strokeString(550,320,0.25,0.2,str,3);
	glColor3f(0.3,0.5,0.7);
	strokeString(50,200,0.2,0.17,"1 . Set the number of electrons using the menu",2);
	strokeString(50,150,0.2,0.17,"2 . Press (Enter) to start the simulation",2);
	//glColor3f(1,0.3,0.6);
	//strokeString(750,180,0.15,0.15,"By:",2);
	//strokeString(700,130,0.3,0.18,"HARINI.V",2);
	//strokeString(700,90,0.3,0.2,"CED18I023",2);
	glutSwapBuffers();
}
...
int main(int argc,char **argv)
{
	...
	glutCreateWindow("Motion of electrons around an atom");
	initfirst();
